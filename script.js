const apiKey = 'e1d8cad4b80942a6adf43241241510';  // API key yang Anda dapatkan
const city = 'Jayapura';
...
fetch(apiURL)
    ...
    .then(data => {
        ...
        <img src="https:${currentWeather.condition.icon}" alt="${currentWeather.condition.text}" class="icon">
